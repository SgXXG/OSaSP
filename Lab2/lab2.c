...
#include<libgen.h>
/*
Sum size of files in selected catalog and sub catalogs
*/
...
int main(int argc, char **argv){
	...
	if(argc<3){
        ...
        fprintf(stderr, "directory: start directory to check: %s\n\t", argv[1]);
        fprintf(stderr, "filename: name of file to write: %s\n", argv[2]);
		return -1;
	}
